...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            # Train the model, and also write summaries. Every 10th step,
            # measure test-set accuracy, and write test summaries All other
            # steps, run train_step on training data, & add training summaries
            yo = []
